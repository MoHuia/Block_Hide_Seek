...
import com.mohuia.block_hide_seek.client.render.QuadFxAPI.Color;
import com.mohuia.block_hide_seek.client.render.QuadFxAPI.FaceDir;
import com.mohuia.block_hide_seek.client.render.QuadFxAPI.Sample;
import com.mohuia.block_hide_seek.client.render.QuadFxAPI.Shader;
...
public final class RaderEnergyShader implements Shader {
    ...
    public Color shade(Sample s) {
        ...
        return Color.rgba(r, g, b, finalAlpha);
    }
