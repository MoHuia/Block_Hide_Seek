...
public class S2CSyncConfig {
    ...
    public S2CSyncConfig(int duration, int hits, int seekers, String hiderTag, String lobbyTag, int radarRange, int radarCooldown, int vanishMana,int decoyCount,int decoyCooldown) {
